...
"""
    ...
    def "input and output properties are not evaluated too often"() {
        ...
        def expectedIncrementalCounts = GradleContextualExecuter.configCache ?
            [inputFile: 2, outputFile: 2, nestedInput: 2, inputValue: 1, nestedInputValue: 1]
            : expectedCounts
        def expectedUpToDateCounts = GradleContextualExecuter.configCache ?
            [inputFile: 1, outputFile: 1, nestedInput: 2, inputValue: 1, nestedInputValue: 1]
            : [inputFile: 2, outputFile: 1, nestedInput: 3, inputValue: 1, nestedInputValue: 1]
